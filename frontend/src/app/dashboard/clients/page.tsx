      ...
      <Stack spacing={3}>
        <Stack direction="row" spacing={3}>
          <Stack spacing={1} sx={{ flex: '1 1 auto' }}>
            ...
            {/* Subtitle: clarify purpose and improve hierarchy */}
            <Typography variant="body2" sx={{ color: 'text.secondary' }}>
              Manage clients and view contacts.
            </Typography>
          </Stack>
          <div>
            <Button component={Link} href={paths.dashboard.createClient} startIcon={<PlusIcon fontSize="var(--icon-fontSize-md)" />} variant="contained">
              Create Client
            </Button>
          </div>
        </Stack>
